...
# Build script for ASL FIFO Basic Example
#
...
#
# Date: 12 August 2025
# Brief: Build script for FIFO basic example with file simulation
...
print_info "========================================"
print_info "Starting ASL FIFO Basic Example build..."
print_info "========================================"
...
# Build the example.
print_info "Building FIFO basic example..."
...
print_info "Compiling basic_fifo.c..."
gcc $CFLAGS $CORE_INC_PATH -c ../basic_fifo.c
# Link executable
print_info "Linking basic_fifo..."
gcc main.o basic_fifo.o -L ./default_libasl/lib -lasl -static -o basic_fifo_example
