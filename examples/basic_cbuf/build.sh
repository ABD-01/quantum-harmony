...
# Build script for ASL CBUF Basic Example
#
...
#
# Date: 12 August 2025
# Brief: Build script for CBUF Basic example with file simulation
...
print_info "========================================"
print_info "Starting ASL CBUF Basic Example build..."
print_info "========================================"
...
# Build the example.
print_info "Building CBUF basic example..."
...
print_info "Compiling basic_cbuf.c..."
gcc $CFLAGS $CORE_INC_PATH -c ../basic_cbuf.c
# Link executable
print_info "Linking basic_cbuf..."
gcc main.o basic_cbuf.o -L ./default_libasl/lib -lasl -lpthread -static -o basic_cbuf_example
