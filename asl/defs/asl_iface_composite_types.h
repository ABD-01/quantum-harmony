 ...
 *  @date       22 August 2025
 *
 *  @brief      Header for the 'asl_iface_composite_types' Class.
...
#if !defined(ASL_IFACE_COMPOSITE_TYPES_H)
#define ASL_IFACE_COMPOSITE_TYPES_H
...
#endif /* ASL_IFACE_COMPOSITE_TYPES_H */
